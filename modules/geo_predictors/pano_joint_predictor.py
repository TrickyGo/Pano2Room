    ...
    def __call__(self, key, img, ref_distance, mask, gen_res=512, 
        ...
        for i in range(n_pers):
            with torch.no_grad():
                ...
                pred_depth = self.depth_predictor.predict_depth(pers_imgs[i: i+1], intri=intri, pers_distance=pers_distances[i: i+1], pers_mask=pers_masks[i: i+1]).cuda().clip(0., None)  # [1, 1, res, res]
